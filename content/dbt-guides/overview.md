...
| #                                        | カテゴリ                 | 検証項目数 | 所要時間 | 状態    |
| ---------------------------------------- | ------------------------ | ---------- | -------- | ------- |
| [](../dbt-setup/project-basic-config.md) | **プロジェクト基本設定** | 15項目     | 2時間    | ✅ 完了 |
| [](../dbt-setup/bigquery-connection.md)  | **BigQuery接続設定**     | 20項目     | 2時間    | ✅ 完了 |
...
| [](../dbt-models/documentation-config.md)    | **ドキュメント設定**     | 5項目      | 1時間    | ✅ 完了 |
| [](../dbt-setup/performance-optimization.md) | **パフォーマンス最適化** | 10項目     | 2時間    | ✅ 完了 |
...
| #                                    | カテゴリ         | 検証項目数 | 所要時間 | 状態    |
| ------------------------------------ | ---------------- | ---------- | -------- | ------- |
| [](../dbt-models/snapshot-config.md) | **Snapshots**    | 12項目     | 2時間    | ✅ 完了 |
| [](../dbt-setup/seed-config.md)      | **Seeds**        | 5項目      | 1時間    | ✅ 完了 |
| [](../dbt-models/hooks-config.md)    | **Hooks**        | 8項目      | 1.5時間  | ✅ 完了 |
| [](../dbt-setup/other-config.md)     | **その他の設定** | 10項目     | 1.5時間  | ✅ 完了 |
