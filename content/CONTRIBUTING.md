...
- index/READMEファイルの本文は **200行以内** に収める
- 詳細な技術ドキュメントは別ファイルとして作成
- index/READMEファイルには概要とリンク集のみを記載
...
3. **絵文字の過度な使用** - 見出しや重要な箇所に限定
4. **大きなバイナリファイルのコミット** - 画像は最適化してから追加
5. **プライベート情報の記載** - 公開されることを前提に
6. **プロモーショナル表現** - "完全"、"最強"、"究極" などの誇張表現
7. **dbt用語の日本語訳** - Seeds/Snapshots/Hooks/Models/Testsは英語で
