...
4. **絵文字の過度な使用** - 見出しや重要な箇所に限定
5. **大きなバイナリファイルのコミット** - 画像は最適化してから追加
6. **プライベート情報の記載** - 公開されることを前提に
7. **プロモーショナル表現** - "完全"、"最強"、"究極" などの誇張表現
8. **dbt用語の日本語訳** - Seeds/Snapshots/Hooks/Models/Testsは英語で
