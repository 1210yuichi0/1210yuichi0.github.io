...
| #                                             | カテゴリ                 | 検証項目数 | 所要時間 | 状態    |
| --------------------------------------------- | ------------------------ | ---------- | -------- | ------- |
| [](../dbt-connection/project-basic-config.md) | **プロジェクト基本設定** | 15項目     | 2時間    | ✅ 完了 |
| [](../dbt-connection/bigquery-connection.md)  | **BigQuery接続設定**     | 20項目     | 2時間    | ✅ 完了 |
| [](../dbt-models/models.md)                   | **Models**               | 30項目     | 4時間    | ✅ 完了 |
...
| #                                             | カテゴリ                 | 検証項目数 | 所要時間 | 状態    |
| --------------------------------------------- | ------------------------ | ---------- | -------- | ------- |
| [](../dbt-testing/testing-config.md)          | **Tests**                | 15項目     | 3時間    | ✅ 完了 |
| [](../dbt-config/documentation-config.md)     | **ドキュメント設定**     | 5項目      | 1時間    | ✅ 完了 |
| [](../dbt-config/performance-optimization.md) | **パフォーマンス最適化** | 10項目     | 2時間    | ✅ 完了 |
...
| #                                         | カテゴリ         | 検証項目数 | 所要時間 | 状態    |
| ----------------------------------------- | ---------------- | ---------- | -------- | ------- |
| [](../dbt-performance/snapshot-config.md) | **Snapshots**    | 12項目     | 2時間    | ✅ 完了 |
| [](../dbt-config/seed-config.md)          | **Seeds**        | 5項目      | 1時間    | ✅ 完了 |
| [](../dbt-config/hooks-config.md)         | **Hooks**        | 8項目      | 1.5時間  | ✅ 完了 |
| [](../dbt-config/other-config.md)         | **その他の設定** | 10項目     | 1.5時間  | ✅ 完了 |
