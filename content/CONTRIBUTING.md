...
5. **プロモーショナル表現** - "完全"、"最強"、"究極" などの誇張表現
6. **dbt用語の日本語訳** - Seeds/Snapshots/Hooks/Models/Testsは英語で
